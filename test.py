...
parser.add_argument("--folder", type=str, help="Path to the Sigma file or folder containing Sigma files.")
...
# main(".\\SigmaRules\\SigmaHQ\\sigma\\rules\\windows\\process_creation", "")
main_file(".\\SigmaRules\\SigmaHQ\\sigma\\rules\\windows\\process_creation\\proc_creation_win_susp_add_user_privileged_group.yml", "")
# table fields: host, ParentImage, Image, CommandLine
